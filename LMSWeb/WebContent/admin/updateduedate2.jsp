...
<table border="3" id="bookLoansTable">
	<tr>
		...
		<tr>
			...
			<td>
			<button type="submit" onclick="updateDueDate(<%=bl.getBook().getBookId()%>,<%=bl.getBorrower().getCardNo()%>,<%=bl.getLibraryBranch().getBranchId()%>)">EXTEND 1 DAY</button>
		 	</td>
		</tr>
		<% } %>
